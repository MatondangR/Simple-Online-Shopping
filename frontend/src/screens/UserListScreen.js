...
import { FaTrash, FaEdit, FaPlus, FaCheckCircle, FaTimes } from 'react-icons/fa'
  ...
  return (
    <>
        ...
        <div className='modal-dialog'>
          <div className='modal-content modal-background'>
            <div className='modal-header'>
              <h5 className='modal-title text-light' id='editUserModalLabel'>
      ...
      <div className='d-flex justify-content-between'>
        <h1 className='fs-6 text-light'>Users</h1>
        <button
              ...
              <tbody>
                {currentItems.map((user) => (
                  <tr key={user._id}>
                    ...
                    <td>{user.isAdmin ? <FaCheckCircle /> : <FaTimes />}</td>
